...
addToValidate('form_SubpanelQuickCreate_Contacts', 'fam_family_contacts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_fam_family_contacts_FROM_fam_family_TITLE' module='Contacts' for_js=true}{literal}' );
