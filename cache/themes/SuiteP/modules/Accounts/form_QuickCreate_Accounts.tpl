...
addToValidate('form_QuickCreate_Accounts', 'phone', 'varchar', false,'{/literal}{sugar_translate label='LBL_PHONE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'status', 'enum', false,'{/literal}{sugar_translate label='LBL_STATUS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'test_field', 'varchar', false,'{/literal}{sugar_translate label='LBL_TEST_FIELD' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'gender_c', 'radioenum', false,'{/literal}{sugar_translate label='LBL_GENDER' module='Accounts' for_js=true}{literal}' );
