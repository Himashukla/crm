<?php 
 $GLOBALS["dictionary"]["fam_family"]=array (
  'table' => 'fam_family',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'fam_family_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'fam_family_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'fam_family_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_fam_family',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'fam_family_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'fam_family_email_addresses',
      'module' => 'EmailAddress',
      'source' => 'non-db',
    ...
    'fam_family_fp_event_locations_1_name' => 
    array (
    ...
    'fam_family_fp_event_locations_1fp_event_locations_idb' => 
    array (
